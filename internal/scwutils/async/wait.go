// This is a ripoff from https://github.com/scaleway/scaleway-sdk-go/blob/v1.0.0-beta.33/internal/async/wait.go needed for
// the block/wait.go file to work properly.
